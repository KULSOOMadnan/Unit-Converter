...
CATEGORIES = {
    "Length": ["meters", "feet", "inches", "kilometers", "miles", "yards", "centimeters", "millimeters"],
    "Weight": ["kilograms", "pounds", "ounces", "grams", "milligrams"],
    "Temperature": ["celsius", "fahrenheit", "kelvin"],
    "Volume": ["liters", "gallons", "milliliters", "cubic_meters", "cubic_centimeters"],
...
def convert_units(value, from_unit, to_unit, category):
    ...
    try:
        ...
        st.error(f"Unsupported unit conversion from {from_unit} to {to_unit} in category {category}.")
        return None
...
app_mode = st.sidebar.radio("Go to", ["Unit Converter", "Currency Converter"])
